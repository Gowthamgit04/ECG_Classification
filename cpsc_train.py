...
# ---------------- Settings ----------------
NPZ_PATH = "CPSC2021_3class_80_20.npz"
MODEL_PATH = Path("cnn_bilstm_attention_explaincpsc.h5")
...
print("\nClassification Report:\n",
      classification_report(y_true, y_pred, labels=range(len(classes)), target_names=classes))
